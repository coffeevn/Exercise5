...
import com.example.along.exercise5.adapter.MyRecyclerViewAdapter;
...
public class ToDoFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        MyRecyclerViewAdapter adapterRecyclerView = new MyRecyclerViewAdapter(realm.where(Item.class).equalTo("done",false).findAll());
